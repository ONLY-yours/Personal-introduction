...
//            startActivity(Intent(this, BlueToothActivity::class.java))
        ...
        Amap.setOnClickListener {
            startActivity(Intent(HomeActivity@this,AMapActivity::class.java))
        }


        Calculator.setOnClickListener {
            startActivity(Intent(HomeActivity@this,CalculatorActivity::class.java))
        }

        Calendar.setOnClickListener {
            startActivity(Intent(HomeActivity@this,MessageAddActivity::class.java))
        }
    }
